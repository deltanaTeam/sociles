...
Route::post('/isFollowing', [ApiController::class,'isFollowing']);
...
Route::get('/user_stories', [ApiController::class, 'get_all_user_stories']);
Route::get('/get_all_stories', [ApiController::class, 'get_all_stories']);
...
Route::get('/userfollower', [ApiController::class,'userfollower']);

Route::get('/followers', [ApiController::class,'followers']);
